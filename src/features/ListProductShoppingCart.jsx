...
const ListProductShoppingCart = () => {
    ...
    const canIncreaseQty = (prod) =>
        parseInt(prod.quantity_sold || 0, 10) < parseInt(prod.quantity_product || 0, 10);

    const handleIncrease = (prod) => {
        if (canIncreaseQty(prod)) dispatch(addToCart(prod));
                    ...
                    <div className="sc-empty">
                        <div className="sc-empty-icon">
                            <svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="463" height="406" viewBox="0 0 463 406" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M113.498 174.198L185.229 161.102C186.315 160.904 187.035 159.862 186.837 158.776L175.188 94.9675C174.99 93.8809 173.948 93.1609 172.862 93.3592L101.131 106.455C100.044 106.653 99.3242 107.695 99.5226 108.781L111.171 172.589C111.37 173.676 112.412 174.396 113.498 174.198Z" fill="#d6e2fb" />
                                <path d="M113.498 174.198L185.229 161.102C186.315 160.904 187.035 159.862 186.837 158.776L175.188 94.9675C174.99 93.8809 173.948 93.1609 172.862 93.3592L101.131 106.455C100.044 106.653 99.3242 107.695 99.5226 108.781L111.171 172.589C111.37 173.676 112.412 174.396 113.498 174.198Z" fill="url(#paint2_linear_243_1817)" />
                                <path d="M291.561 117.821L363.969 126.416C365.066 126.546 366.061 125.762 366.191 124.665L373.836 60.2547C373.967 59.1579 373.183 58.1631 372.086 58.0329L299.678 49.4381C298.581 49.3079 297.587 50.0916 297.456 51.1885L289.811 115.599C289.681 116.696 290.464 117.691 291.561 117.821Z" fill="#d6e2fb" />
                                <path d="M291.561 117.821L363.969 126.416C365.066 126.546 366.061 125.762 366.191 124.665L373.836 60.2547C373.967 59.1579 373.183 58.1631 372.086 58.0329L299.678 49.4381C298.581 49.3079 297.587 50.0916 297.456 51.1885L289.811 115.599C289.681 116.696 290.464 117.691 291.561 117.821Z" fill="url(#paint3_linear_243_1817)" />
                                <path d="M149.985 66.7489L244.75 54.7836C245.944 54.6328 247 55.5639 247 56.7679V135.192C247 136.218 246.223 137.078 245.201 137.181L159.941 145.803C158.861 145.912 157.891 145.141 157.755 144.065L148.251 68.9843C148.113 67.8882 148.889 66.8873 149.985 66.7489Z" fill="#d6e2fb" />
                                <path d="M149.985 66.7489L244.75 54.7836C245.944 54.6328 247 55.5639 247 56.7679V135.192C247 136.218 246.223 137.078 245.201 137.181L159.941 145.803C158.861 145.912 157.891 145.141 157.755 144.065L148.251 68.9843C148.113 67.8882 148.889 66.8873 149.985 66.7489Z" fill="url(#paint4_linear_243_1817)" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M162.506 148.462C180.165 143.145 190.199 124.925 185.054 107.839C179.91 90.7532 161.484 81.1027 143.824 86.42C126.165 91.7373 116.131 109.957 121.276 127.043C126.42 144.129 144.846 153.78 162.506 148.462ZM163.082 150.377C181.752 144.756 192.446 125.453 186.969 107.262C181.492 89.0723 161.917 78.8834 143.248 84.5049C124.578 90.1264 113.883 109.43 119.361 127.62C124.838 145.81 144.413 155.999 163.082 150.377Z" fill="#2563eb" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M263.399 77.7719C277.172 71.2541 283.114 55.1422 276.817 41.8362C270.52 28.5303 254.293 22.9094 240.52 29.4272C226.748 35.945 220.806 52.0569 227.103 65.3629C233.4 78.6689 249.626 84.2897 263.399 77.7719ZM264.254 79.5797C278.981 72.6105 285.415 55.3291 278.625 40.9807C271.834 26.6323 254.391 20.6502 239.665 27.6194C224.938 34.5886 218.505 51.87 225.295 66.2184C232.085 80.5668 249.528 86.5489 264.254 79.5797Z" fill="#2563eb" />
                                <path d="M309.802 21.7873L190.281 77.1752C189.292 77.6333 188.852 78.7985 189.291 79.7958L241.158 197.587C241.617 198.63 242.853 199.079 243.875 198.574L371.633 135.423C372.652 134.92 373.047 133.669 372.502 132.672L312.398 22.6431C311.893 21.7187 310.758 21.3444 309.802 21.7873Z" fill="#d6e2fb" />
                                <path d="M309.802 21.7873L190.281 77.1752C189.292 77.6333 188.852 78.7985 189.291 79.7958L241.158 197.587C241.617 198.63 242.853 199.079 243.875 198.574L371.633 135.423C372.652 134.92 373.047 133.669 372.502 132.672L312.398 22.6431C311.893 21.7187 310.758 21.3444 309.802 21.7873Z" fill="url(#paint5_linear_243_1817)" />
                                <path d="M210.322 97.9852L104.717 128.504C103.739 128.787 103.13 129.759 103.301 130.763L121.715 238.338C121.879 239.298 122.712 240 123.686 240H271.929C273.374 240 274.342 238.514 273.758 237.191L212.706 99.0979C212.301 98.1827 211.283 97.7074 210.322 97.9852Z" fill="#d6e2fb" />
                                <path d="M210.322 97.9852L104.717 128.504C103.739 128.787 103.13 129.759 103.301 130.763L121.715 238.338C121.879 239.298 122.712 240 123.686 240H271.929C273.374 240 274.342 238.514 273.758 237.191L212.706 99.0979C212.301 98.1827 211.283 97.7074 210.322 97.9852Z" fill="url(#paint6_linear_243_1817)" />
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M408.817 99.6465C423.403 104.054 438.619 96.0942 442.878 82.0029C447.136 67.9116 438.876 52.8564 424.29 48.4485C409.704 44.0405 394.488 52.0008 390.23 66.0921C385.971 80.1834 394.232 95.2386 408.817 99.6465ZM408.239 101.561C423.835 106.274 440.2 97.7768 444.792 82.5815C449.385 67.3862 440.464 51.2472 424.869 46.534C409.273 41.8208 392.907 50.3182 388.315 65.5135C383.723 80.7088 392.643 96.8478 408.239 101.561Z" fill="#2563eb" />
                                <path d="M363.665 50.0055L455.888 78.0106C456.819 78.2934 457.412 79.2052 457.292 80.1709L437.717 237.746C437.593 238.748 436.742 239.5 435.733 239.5H426.86C426.622 239.5 426.385 239.457 426.161 239.374L298.522 191.755C297.431 191.347 296.917 190.098 297.406 189.041L361.268 51.0791C361.688 50.1737 362.71 49.7156 363.665 50.0055Z" fill="#d6e2fb" />
                                <path d="M363.665 50.0055L455.888 78.0106C456.819 78.2934 457.412 79.2052 457.292 80.1709L437.717 237.746C437.593 238.748 436.742 239.5 435.733 239.5H426.86C426.622 239.5 426.385 239.457 426.161 239.374L298.522 191.755C297.431 191.347 296.917 190.098 297.406 189.041L361.268 51.0791C361.688 50.1737 362.71 49.7156 363.665 50.0055Z" fill="url(#paint9_linear_243_1817)" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M373 381C374.657 381 376 379.657 376 378C376 376.343 374.657 375 373 375C371.343 375 370 376.343 370 378C370 379.657 371.343 381 373 381ZM373 385C376.866 385 380 381.866 380 378C380 374.134 376.866 371 373 371C369.134 371 366 374.134 366 378C366 381.866 369.134 385 373 385Z" fill="#9ab7f6" />
                                ...
                                <path d="M293.313 135.032C288.31 137.578 283.372 138.497 278.498 137.79C273.634 137.052 269.019 134.772 264.652 130.951C260.294 127.099 256.389 121.781 252.936 114.995C249.503 108.199 247.527 101.937 247.009 96.208C246.5 90.4486 247.389 85.4059 249.676 81.08C251.983 76.7438 255.628 73.3079 260.611 70.7721C265.593 68.2363 270.517 67.312 275.38 67.9991C280.243 68.6862 284.843 70.9354 289.18 74.7466C293.537 78.5476 297.437 83.8307 300.88 90.5959C304.343 97.4017 306.34 103.705 306.869 109.505C307.408 115.274 306.529 120.337 304.232 124.693C301.956 129.039 298.316 132.486 293.313 135.032ZM288.473 125.522C292.362 123.543 294.457 120.067 294.757 115.094C295.067 110.091 293.32 103.853 289.517 96.3787C287.001 91.4365 284.372 87.547 281.628 84.7104C278.883 81.8737 276.137 80.084 273.387 79.3412C270.627 78.5782 267.961 78.8512 265.388 80.1604C261.52 82.1292 259.44 85.61 259.151 90.6026C258.851 95.5751 260.577 101.773 264.329 109.197C266.835 114.17 269.454 118.09 272.188 120.957C274.943 123.814 277.7 125.624 280.46 126.387C283.21 127.13 285.881 126.841 288.473 125.522Z" fill="#2563eb" />
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M372.947 42.5H460.372L452.029 111.5H364.584L372.947 42.5ZM370.933 42.5H276V111.5H362.569L370.933 42.5ZM274 42.5H179.067L187.431 111.5H274V42.5ZM177.053 42.5H88V40.5H462.628L438.386 241H121.5V239H200.871L193.477 178H110V176H193.235L185.659 113.5H100.5V111.5H185.416L177.053 42.5ZM202.886 239H274V178H195.492L202.886 239ZM276 239H347.114L354.508 178H276V239ZM349.129 239H436.614L443.989 178H356.523L349.129 239ZM444.231 176L451.787 113.5H364.341L356.765 176H444.231ZM195.249 176L187.673 113.5H274V176H195.249ZM276 176H354.751L362.327 113.5H276V176Z" fill="#c8d8fa" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M372.947 42.5H460.372L452.029 111.5H364.584L372.947 42.5ZM370.933 42.5H276V111.5H362.569L370.933 42.5ZM274 42.5H179.067L187.431 111.5H274V42.5ZM177.053 42.5H88V40.5H462.628L438.386 241H121.5V239H200.871L193.477 178H110V176H193.235L185.659 113.5H100.5V111.5H185.416L177.053 42.5ZM202.886 239H274V178H195.492L202.886 239ZM276 239H347.114L354.508 178H276V239ZM349.129 239H436.614L443.989 178H356.523L349.129 239ZM444.231 176L451.787 113.5H364.341L356.765 176H444.231ZM195.249 176L187.673 113.5H274V176H195.249ZM276 176H354.751L362.327 113.5H276V176Z" fill="url(#paint18_radial_243_1817)" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M19 13.5C19 11.8431 20.3431 10.5 22 10.5H49.1674C70.1626 10.5 88.0882 25.6617 91.5715 46.366L132.442 289.298C136.249 311.928 155.842 328.5 178.791 328.5H421C422.657 328.5 424 329.843 424 331.5C424 333.157 422.657 334.5 421 334.5H178.791C152.913 334.5 130.819 315.812 126.525 290.293L85.6546 47.3614C82.6574 29.5461 67.2331 16.5 49.1674 16.5H22C20.3431 16.5 19 15.1569 19 13.5Z" fill="#c8d8fa" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M19 13.5C19 11.8431 20.3431 10.5 22 10.5H49.1674C70.1626 10.5 88.0882 25.6617 91.5715 46.366L132.442 289.298C136.249 311.928 155.842 328.5 178.791 328.5H421C422.657 328.5 424 329.843 424 331.5C424 333.157 422.657 334.5 421 334.5H178.791C152.913 334.5 130.819 315.812 126.525 290.293L85.6546 47.3614C82.6574 29.5461 67.2331 16.5 49.1674 16.5H22C20.3431 16.5 19 15.1569 19 13.5Z" fill="url(#paint19_linear_243_1817)" />
                                <path d="M26 13C26 20.1797 20.1797 26 13 26C5.8203 26 0 20.1797 0 13C0 5.8203 5.8203 0 13 0C20.1797 0 26 5.8203 26 13Z" fill="#c8d8fa" />
                                <path d="M26 13C26 20.1797 20.1797 26 13 26C5.8203 26 0 20.1797 0 13C0 5.8203 5.8203 0 13 0C20.1797 0 26 5.8203 26 13Z" fill="url(#paint20_linear_243_1817)" />
                                <defs>
                                    ...
                                    <linearGradient id="paint2_linear_243_1817" x1="149.363" y1="167.65" x2="136.996" y2="99.9069" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#2563eb" />
                                        <stop offset="1" stopColor="#2563eb" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint3_linear_243_1817" x1="327.765" y1="122.118" x2="335.882" y2="53.7355" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#2563eb" />
                                        <stop offset="1" stopColor="#2563eb" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint4_linear_243_1817" x1="235" y1="114.999" x2="194.594" y2="38.7408" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#c8d8fa" />
                                        <stop offset="1" stopColor="#c8d8fa" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint5_linear_243_1817" x1="287.5" y1="211.5" x2="317.244" y2="98.5683" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#c8d8fa" />
                                        <stop offset="1" stopColor="#c8d8fa" stopOpacity="0" />
                                    </linearGradient>
                                    ...
                                    <linearGradient id="paint15_linear_243_1817" x1="378.796" y1="74.9996" x2="378.796" y2="165" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#c8d8fa" />
                                        <stop offset="1" stopColor="#c8d8fa" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint16_linear_243_1817" x1="282.878" y1="33.5005" x2="282.878" y2="131.906" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#c8d8fa" />
                                        <stop offset="1" stopColor="#c8d8fa" stopOpacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint17_linear_243_1817" x1="174.477" y1="94.4998" x2="174.477" y2="201.383" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#c8d8fa" />
                                        <stop offset="1" stopColor="#c8d8fa" stopOpacity="0" />
                                    </linearGradient>
                                    ...
                                    <linearGradient id="paint19_linear_243_1817" x1="-30.5" y1="-46.5" x2="100.5" y2="-0.499993" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#d6e2fb" />
                                        <stop offset="1" stopColor="#d6e2fb" stopOpacity="0" />
                                    </linearGradient>
            ...
            <div className="sc-root sc-wrap]">
                ...
                <div className="sc-list">
                    {itemsData?.map((prod, i) => {
                        ...
                        const imgSrc = prod?.variants?.[0]?.image;
                        const maxed = !canIncreaseQty(prod);
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="sc-info">
                                    <p className="sc-name">
                                        {prod?.name_product || prod?.description_product?.slice(0, 30) || '—'}
                                    </p>
                                    {prod?.categorie_product && (
                                        <span className="sc-cat">{prod.categorie_product}</span>
                                    )}
                                </div>
                                ...
                                <div className="sc-qty">
                                    ...
                                    >−</button>
                                    <span className={`sc-qty-val ${maxed ? 'sc-qty-maxed' : ''}`}>
                                        {qty}
                                    </span>
                                    <button
                                        type="button"
                                        ...
                                        disabled={maxed}
                                        title={maxed ? t('quantity_limit_error') : ''}
                                    >+</button>
                                </div>

                                {/* Prix unitaire + total ligne */}
                                <div className="sc-price-col">
                                    <p className="sc-total">{total} {prod?.currency_price}</p>
                                    <p className="sc-unit">{price.toFixed(CONSTANTS?.DECIMALS_DIGITS)} / unité</p>
                                </div>
                                ...
                                <button
                                    ...
                                    aria-label={t('tableEntries.action') || 'Supprimer'}
