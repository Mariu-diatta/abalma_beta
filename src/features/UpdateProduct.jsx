...
const AddUploadProduct = () => {
    ...
    const validateProduct = () => {
        ...
        if (dataProduct.currency_price === null) {
        ...
        // Vérif images + variants
        for (let img of imageVariants) {
            if (!img.color || !img.size) {
                return "Chaque image doit avoir une couleur et une taille";
            }
        }
    ...
    const submitForm = async (e) => {
        ...
        try {
            ...
            formData.append("price_product", Number(dataProduct?.price_product)); // 🔥 fix important
            ...
            setIsLoadingSubmit(false); // ✅ spinner toujours stoppé
        }
    };
    ...
    return (
        ...
        <div className="rounded-md flex flex-col justify-center items-center pb-[10dvh] overflow-x-hidden">
...

            {
                ...
                :
                (
                    <div className="py-1 lg:py-2 w-full md:w-1/2 lg:w-1/2 px-4 shadow-2xl rounded-lg bg-white/70 backdrop-blur-md rounded-xl border border-gray-200 p-2">
...
const ProductSummary = ({
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-gradient-to-br from-blue-0 to-blue-50 rounded-2xl shadow-2xl text-gray-900 dark:text-gray-100 flex flex-col gap-6">
