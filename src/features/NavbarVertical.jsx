...
const VertcalNavbar = ({ children }) => {
    ...
    const tabContent = {
        ...
        payment: <ProductModal />,
        dashboard: <AccountDropdown3 />,
                    ...
                    <ul className="space-y-2 ">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm  text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
