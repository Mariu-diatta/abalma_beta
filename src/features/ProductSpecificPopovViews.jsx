...
const ProductSpecifiViews = ({ products, openModal, owners, panelRef }) => {
    ...
    return (
        ...
        <div
            ...
            className={`border-0 flex gap-0  w-full bg-grey-9000 shadow-xs rounded-md mt-1 z-0 py-1 m-0 ${products?.length <= 0 ? "hidden" : "min-h-70 max-h-70 px-0"}`}

        >
            <div style={{ flex: 2 }} className="hidden md:block p-0 m-0 border-0">
            ...
            <div style={{ flex: 3 }} className="p-0 m-0 border-0">
            ...
            <div style={{ flex: 2 }} className=" p-0 m-0 border-0">
