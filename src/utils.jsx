...
export const services = [
    {
        ...
        icon: (<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="622" height="546" viewBox="0 0 622 546" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M69.5 502C78.0604 502 85 495.06 85 486.5C85 477.94 78.0604 471 69.5 471C60.9396 471 54 477.94 54 486.5C54 495.06 60.9396 502 69.5 502ZM69.5 504C79.165 504 87 496.165 87 486.5C87 476.835 79.165 469 69.5 469C59.835 469 52 476.835 52 486.5C52 496.165 59.835 504 69.5 504Z" fill="#374151" />
            ...
            <defs>
                ...
                <linearGradient id="paint15_linear_204_2681" x1="122.839" y1="379" x2="122.839" y2="329" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#9ab7f6" />
                    <stop offset="0.830726" stop-color="#9ab7f6" stop-opacity="0" />
                </linearGradient>
    ...
    },
    {
        ...
        icon: (<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="588" height="574" viewBox="0 0 588 574" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        icon: (<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="506" height="575" viewBox="0 0 506 575" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M231 10H63C46.4315 10 33 23.4315 33 40V481C33 497.569 46.4315 511 63 511H231C247.569 511 261 497.569 261 481V40C261 23.4315 247.569 10 231 10ZM63 0C40.9086 0 23 17.9086 23 40V481C23 503.091 40.9086 521 63 521H231C253.091 521 271 503.091 271 481V40C271 17.9086 253.091 0 231 0H63Z" fill="#d6e2fb" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M231 10H63C46.4315 10 33 23.4315 33 40V481C33 497.569 46.4315 511 63 511H231C247.569 511 261 497.569 261 481V40C261 23.4315 247.569 10 231 10ZM63 0C40.9086 0 23 17.9086 23 40V481C23 503.091 40.9086 521 63 521H231C253.091 521 271 503.091 271 481V40C271 17.9086 253.091 0 231 0H63Z" fill="url(#paint1_linear_204_2030)" />
    ...
    },
    {
        ...
        icon: (<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="411" height="578" viewBox="0 0 411 578" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        icon: (<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="524" height="524" viewBox="0 0 524 524" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M88.1334 458C84.8446 455.08 81.6298 452.079 78.4922 449H290V458H88.1334Z" fill="#c8d8fa" />
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M312.531 382L315.583 392.924C316.296 395.474 314.379 398 311.731 398H89.0374C87.2428 398 85.6679 396.805 85.1849 395.076L81.5312 382H312.531Z" fill="#c8d8fa" />
