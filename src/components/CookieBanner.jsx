...
const CookieBanner = () => {
    ...
    const visibilityAndConsentGiven = (!visible && !consentGiven)
    ...
    return (
        <>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-sm">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-gradient-to-r from-gray-10 to-gray-200  hover:bg-indigo-200 px-4 py-1 rounded-full"
                                >
                                ...
                                <button
                                    ...
                                    className="bg-gradient-to-r from-gray-10 to-red-200  hover:bg-red-200 px-4 py-1 rounded-full"
                                >
            ...
            {
                visibilityAndConsentGiven && (

                    <button
                        onClick={toggleBanner}
                        className="bg-gradient-to-r from-gray-10 to-gray-200 hidden h-7 fixed top-2 right-1/2 z-4 hover:bg-indigo-200 px-4 py-1 rounded-full shadow-sm flex items-center justify-center gap-2 z-0"
                    >
