...
const FollowProfilUser = ({ clientId }) => {
    ...
    if (!currentUser || !currentUser?.is_connected) {
        ...
        return (
            ...
            <button
                onClick={() =>alert("Connexion requise !!")}
                opacity="0.5"
                type="button"
            ...
            <>
               { 
                    ...
                    <button
                        ...
                        className={`max-w-1/3 md:max-w-auto  flex items-center gap-1 rounded-full text-white text-sm px-3 py-1  text-base  text-white transition bg-gradient-to-br from-purple-300 w-2/3 md:w-auto ${isFollow ? "to-indigo-300 to-red-300" : ""} hover:bg-gradient-to-br hover:from-purple-400`}
                    ...
                    <button
                        type="button"
                        className={`max-w-1/3 md:max-w-auto flex items-center gap-1 rounded-full text-white text-sm px-3 py-1  text-base  text-white transition bg-gradient-to-br from-purple-300 w-1/3 md:w-auto ${isFollow ? "to-indigo-300 to-red-300 " : ""} hover:bg-gradient-to-br hover:from-purple-400`}
