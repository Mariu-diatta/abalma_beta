...
export const menuItems = (t) => [

    {
        ...
        to: '/produits/',
        id: "all-products",
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={all_product} alt="" width="25" />,
    },
    ...
    // --- Catégories principales ---
    {
        ...
        id: 'musique',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={music} alt="" width="25" />,
    },
    {
        name: t('Habits'),
        to: '/products/filter/?categorie_product=HABITS',
        id: 'habits',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={tshirt} alt="" width="25" />,
    },
    {
        name: t('Livres'),
        to: '/products/filter/?categorie_product=LIVRES',
        id: 'livres',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={livre} alt="" width="25" />,
    },
    {
        name: t('Jouets'),
        to: '/products/filter/?categorie_product=JOUETS',
        id: 'jouets',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={toy_car} alt="" width="25" />,
    },
    {
        name: t('Vehicules'),
        to: '/products/filter/?categorie_product=VEHICULES',
        id: 'vehicules',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={road} alt="" width="25" />,
    },
    {
        name: t('Meubles'),
        to: '/products/filter/?categorie_product=MEUBLES',
        id: 'meubles',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={bureau} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.JEUX_VIDEO'),
        to: '/products/filter/?categorie_product=JEUX_VIDEO',
        id: 'jeux-video',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={gaming_} alt="" width="25" />,
    },
    {
        name: t('Sacs'),
        to: '/products/filter/?categorie_product=SACS',
        id: 'sacs',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={bags} alt="" width="25" />,
    },
    ...
    // --- Nouvelles catégories ---
    {
        ...
        id: 'electronique',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={circuit_board} alt="" width="25" />,
    },
    {
        name: t('Sport'),
        to: '/products/filter/?categorie_product=SPORT',
        id: 'sport',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={sport} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.ELECTROMENAGER'),
        to: '/products/filter/?categorie_product=ELECTROMENAGER',
        id: 'electromenager',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={home_appliance} alt="" width="25" />,
    },
    {
        name: t('Bijoux'),
    ...
    },
    {
        ...
        id: 'cosmetiques',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={cosmetics} alt="" width="25" />,
    },
    {
        name: t('Sante_beaute'),
        to: '/products/filter/?categorie_product=SANTE_BEAUTE',
        id: 'sante-beaute',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={health_beauty} alt="" width="25" />,
    },
    {
        name: t('Maison_decoration'),
        to: '/products/filter/?categorie_product=MAISON_DECORATION',
        id: 'maison-decoration',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={home_deco} alt="" width="25" />
    },
    {
        name: t('Bebes_puericulture'),
        to: '/products/filter/?categorie_product=BEBES',
        id: 'bebes',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={baby} alt="" width="25" />,
    },
    {
        name: t('Jardinage'),
        to: '/products/filter/?categorie_product=JARDINAGE',
        id: 'jardinage',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={gardening} alt="" width="25" />,
    },
    {
        name: t('Bricolage'),
        to: '/products/filter/?categorie_product=BRICOLAGE',
        id: 'bricolage',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={tools} alt="" width="25" />,
    },
    {
        name: t('Animaux'),
        to: '/products/filter/?categorie_product=ANIMAUX',
        id: 'animaux',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={pets} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.TELEPHONIE'),
        to: '/products/filter/?categorie_product=TELEPHONY',
        id: 'telephonie',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={phone} alt="" width="25" />,
    },
    {
        name: t('Chaussures'),
    ...
    },
    {
        ...
        id: 'films-series',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={movies} alt="" width="25" />,
    },
    {
        name: t('Services'),
        to: '/products/filter/?categorie_product=SERVICES',
        id: 'services',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={services} alt="" width="25" />,
    },
    {
        name: t('Art_artisanat'),
        to: '/products/filter/?categorie_product=ART',
        id: 'art',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={art} alt="" width="25" />,
    },
    {
        name: t('Voyage_loisirs'),
        to: '/products/filter/?categorie_product=VOYAGE',
        id: 'voyage',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={travel} alt="" width="25" />,
    },
    {
        name: t('High_Tech'),
        to: '/products/filter/?categorie_product=HIGH_TECH',
        id: 'high-tech',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={hightech} alt="" width="25" />,
    },
    {
        name: t('Auto_Moto'),
        to: '/products/filter/?categorie_product=AUTOMOTO',
        id: 'automoto',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={automoto} alt="" width="25" />,
    },
    {
        name: t('Materiel_medical'),
        to: '/products/filter/?categorie_product=MEDICAL',
        id: 'medical',
        svg: <img className="rounded-sm bg-gray-50 grayscale" src={medical} alt="" width="25" />,
    },
    {
        name: t('jewelry'),
