...
export const menuItems = (t) => [

    {
        ...
        to: '/produits/',
        id: "all-products",
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={all_product} alt="" width="25" />,
    },
    ...
    // --- Catégories principales ---
    {
        ...
        id: 'musique',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={music} alt="" width="25" />,
    },
    {
        name: t('Habits'),
        to: '/products/filter/?categorie_product=HABITS',
        id: 'habits',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={tshirt} alt="" width="25" />,
    },
    {
        name: t('Livres'),
        to: '/products/filter/?categorie_product=LIVRES',
        id: 'livres',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={livre} alt="" width="25" />,
    },
    {
        name: t('Jouets'),
        to: '/products/filter/?categorie_product=JOUETS',
        id: 'jouets',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lgbg-none" src={toy_car} alt="" width="25" />,
    },
    {
        name: t('Vehicules'),
        to: '/products/filter/?categorie_product=VEHICULES',
        id: 'vehicules',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none"  src={road} alt="" width="25" />,
    },
    {
        name: t('Meubles'),
        to: '/products/filter/?categorie_product=MEUBLES',
        id: 'meubles',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={bureau} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.JEUX_VIDEO'),
        to: '/products/filter/?categorie_product=JEUX_VIDEO',
        id: 'jeux-video',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={gaming_} alt="" width="25" />,
    },
    {
        name: t('Sacs'),
        to: '/products/filter/?categorie_product=SACS',
        id: 'sacs',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={bags} alt="" width="25" />,
    },
    ...
    // --- Nouvelles catégories ---
    {
        ...
        id: 'electronique',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={circuit_board} alt="" width="25" />,
    },
    {
        name: t('Sport'),
        to: '/products/filter/?categorie_product=SPORT',
        id: 'sport',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={sport} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.ELECTROMENAGER'),
        to: '/products/filter/?categorie_product=ELECTROMENAGER',
        id: 'electromenager',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={home_appliance} alt="" width="25" />,
    },
    {
        name: t('Bijoux'),
        to: '/products/filter/?categorie_product=BIJOUX',
        id: 'bijoux',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={jewelry} alt="" width="25" />,
    },
    {
        name: t('Cosmetiques'),
        to: '/products/filter/?categorie_product=COSMETIQUES',
        id: 'cosmetiques',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={cosmetics} alt="" width="25" />,
    },
    {
        name: t('Sante_beaute'),
        to: '/products/filter/?categorie_product=SANTE_BEAUTE',
        id: 'sante-beaute',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={health_beauty} alt="" width="25" />,
    },
    {
        name: t('Maison_decoration'),
        to: '/products/filter/?categorie_product=MAISON_DECORATION',
        id: 'maison-decoration',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={home_deco} alt="" width="25" />
    },
    {
        name: t('Bebes_puericulture'),
        to: '/products/filter/?categorie_product=BEBES',
        id: 'bebes',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={baby} alt="" width="25" />,
    },
    {
        name: t('Jardinage'),
        to: '/products/filter/?categorie_product=JARDINAGE',
        id: 'jardinage',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={gardening} alt="" width="25" />,
    },
    {
        name: t('Bricolage'),
        to: '/products/filter/?categorie_product=BRICOLAGE',
        id: 'bricolage',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={tools} alt="" width="25" />,
    },
    {
        name: t('Animaux'),
        to: '/products/filter/?categorie_product=ANIMAUX',
        id: 'animaux',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={pets} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.TELEPHONIE'),
        to: '/products/filter/?categorie_product=TELEPHONY',
        id: 'telephonie',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={phone} alt="" width="25" />,
    },
    {
        name: t('Chaussures'),
        to: '/products/filter/?categorie_product=CHAUSSURES',
        id: 'chaussures',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={shoes} alt="" width="25" />,
    },
    {
        name: t('Films_series'),
        to: '/products/filter/?categorie_product=FILMS_SERIES',
        id: 'films-series',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={movies} alt="" width="25" />,
    },
    {
        name: t('Services'),
        to: '/products/filter/?categorie_product=SERVICES',
        id: 'services',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={services} alt="" width="25" />,
    },
    {
        name: t('Art_artisanat'),
        to: '/products/filter/?categorie_product=ART',
        id: 'art',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={art} alt="" width="25" />,
    },
    {
        name: t('Voyage_loisirs'),
        to: '/products/filter/?categorie_product=VOYAGE',
        id: 'voyage',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={travel} alt="" width="25" />,
    },
    {
        name: t('High_Tech'),
        to: '/products/filter/?categorie_product=HIGH_TECH',
        id: 'high-tech',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={hightech} alt="" width="25" />,
    },
    {
        name: t('Auto_Moto'),
        to: '/products/filter/?categorie_product=AUTOMOTO',
        id: 'automoto',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={automoto} alt="" width="25" />,
    },
    {
        name: t('Materiel_medical'),
        to: '/products/filter/?categorie_product=MEDICAL',
        id: 'medical',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={medical} alt="" width="25" />,
    },
    {
        name: t('jewelry'),
    ...
    },
    {
        ...
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={materiel_info} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.CAHIERS'),
        to: '/products/filter/?categorie_product=CAHIERS',
        id: 'cahiers',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={cahier} alt="" width="25" />,
    },
    {
    ...
    },
    {
        ...
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={fourniture} alt="" width="25" />,
    },
    {
        name: t('ListItemsFilterProduct.ALIMENTATION'),
        to: '/products/filter/?categorie_product=ALIMENTATION',
        id: 'alimentation',
        svg: <img className="rounded-lg bg-gray-50 grayscale shadow-lg bg-none" src={nouriture} alt="" width="25" />,
    },
];
