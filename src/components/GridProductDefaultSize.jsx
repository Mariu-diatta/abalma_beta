            ...
            <div className="grid gap-4">
                <div>
                    ...
                    <div className="flex items-center justify-between space-x-3">
                        ...
                        <p className="tracking-normal text-gray-500 md:text-sm dark:text-gray-400">Saussure neuve.</p>

                        <span className="hidden text-sm font-medium text-gray-900 line-through dark:text-white">109</span><span class="ms-3 text-lg font-medium text-gray-900 dark:text-white">$79</span>
