...
const AttentionAlertMesage = ({ content, title }) => {
    ...
    return (
        ...
        <div className="fixed top-10 left-1/2 transform -translate-x-1/2 z-80 w-full max-w-xl ">

            <div

                className="border-yellow bg-yellow-light-4 flex w-full rounded-lg border-l-[6px]  p-2 md:py-6 shadow-md dark:bg-dark"
            ...
            >
                ...
                <div className="bg-yellow flex h-[34px] w-[34px]  rounded-md">
