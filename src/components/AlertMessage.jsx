...
const AttentionAlertMesage = ({ content, title }) => {
    ...
    return (
        <div className="fixed top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-80 w-full max-w-xl bg-transparent shadow-lg backdrop-blur-md">
            <div
                className={`flex w-full rounded-lg border-l-[6px] p-4 md:py-6 shadow-md
          ${isError ? "border-l-red-500 text-red-600" : "border-l-blue-500 text-blue-700"}
        `}
            >
                <div className="flex h-[34px] w-[34px] rounded-md mr-4">
                    {/* Icône d'alerte */}
                    <svg
                        width="18"
                        height="18"
                    ...
                    >
                        <path
                            ...
                            fill={isError ? "#DC2626" : "#2563EB"} // rouge ou bleu
                        />
                        <path
