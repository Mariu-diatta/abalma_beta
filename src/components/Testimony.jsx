            ...
            >
                ...
                {length > 1 && (
                    <>
                        <button
                            onClick={goPrev}
                            className="absolute left-4 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full p-2 hover:scale-110 transition"
                        >
                            ‹
                        </button>
                        ...
                        <button
                            onClick={goNext}
                            className="absolute right-4 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full p-2 hover:scale-110 transition"
                        >
                            ›
                        </button>
                    </>
