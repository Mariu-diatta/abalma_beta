    ...
    return (
        <div className="relative mb-6 w-auto">
            ...
            <input
                ...
                required={required}
                ref={ref}
                className="block rounded-t-lg px-1  lg:px-2.5 pb-2.5 pt-5 w-full text-md text-gray-700  border-0 border-b-1 border-gray-300 appearance dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-100 peer"
                {...rest}
            />
            <label
                htmlFor={inputId}
