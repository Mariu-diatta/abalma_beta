    ...
    return (
        ...
        <NavLink
            ...
            className={
                ...
                ({ isActive }) =>
                    `shadow-lg m-1 dark:bg-dark  border-gray-[0.1px] border-gray-200 rounded-full inline-flex items-center justify-center py-1 px-2 text-center text-[14px] transition-all duration-200
                 ${isActive
