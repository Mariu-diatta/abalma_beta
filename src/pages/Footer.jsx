            ...
            >
                <div className="flex flex-col lg:flex-row justify-between gap-10">
                    <LinkGroup header={t("Resources")}>
                        ...
                        <NavLink link="/#" label={t("footer_product")} className="text-sm" />
                        <NavLink link="/#" label={t("footer_userflow")} className="text-sm" />
                    </LinkGroup>
                    <LinkGroup header="Company">
                        <NavLink link="/#" label={t("about_app")} className="text-sm" />
                        <NavLink link="/#" label={t("contact_support")} className="text-sm" />
                        <NavLink link="/#" label={t("success_history")} className="text-sm" />
                    </LinkGroup>
                    <LinkGroup header={t("quick_links")}>
                        <NavLink link="/#" label={t("premium_support")} className="text-sm" />
                        <NavLink link="/#" label={t("our_services")} className="text-sm" />
                        <NavLink link="/#" label={t("know_our_team")} className="text-sm" />
                    </LinkGroup>
                </div>
            </div>

            {/* Bas de page */}
            <div className="w-full bg-gray-200 text-center text-sm text-gray-600 dark:text-gray-400 px-4 py-4 mt-10 border-t border-gray-200 dark:border-dark-3">
