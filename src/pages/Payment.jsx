...
export function PaymentAppPayPal({ amount }) {
    ...
    return (
        ...
        <PayPalScriptProvider options={{ "client-id": "ASRImaOJeT2qbUoitUQbwzmVuAoS80Vab1OSkmWS18wRC1xcb7MdVb29K-Zjf8wbsXZnM-pKkxqxtJ-u" }}>

            <div style={{ maxWidth: "400px", margin: "50px auto" }}>

                <h3 className="flex items-center m-auto justify-center">Test de paiement PayPal</h3>
                ...
                <PayPalButtons
                            ...
                            purchase_units: [
                                {
                                    amount: {
                                        ...
                                        value: parseFloat(amount).toFixed(2), // ✅ ici c’est corrigé
                                    },
                                },
                            ],
                        });
                    ...
                    onApprove={(data, actions) => {
                        return actions.order.capture().then((details) => {
                            alert(
                                `Paiement fictif effectué par ${details.payer.name.given_name}`
                            );
