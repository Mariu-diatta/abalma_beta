...
const HelpPage = () => {
    ...
    return (
        ...
        <div className="mb-5 m-auto mb-6 pb-[20dvh]">
            ...
            <div className="text-start max-w-md dark:text-white flex items-center gap-1 ">
                ...
                <svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="674" height="447" viewBox="0 0 674 447" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M529.768 447C564.466 400.375 585 342.586 585 280C585 125.36 459.64 0 305 0C150.36 0 25 125.36 25 280C25 342.586 45.5338 400.375 80.2318 447H529.768Z" fill="#d6e2fb" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M529.768 447C564.466 400.375 585 342.586 585 280C585 125.36 459.64 0 305 0C150.36 0 25 125.36 25 280C25 342.586 45.5338 400.375 80.2318 447H529.768Z" fill="url(#paint0_linear_748_166)" />
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M36 405C35.4477 405 35 405.448 35 406V447H33V406C33 404.343 34.3431 403 36 403H177C178.657 403 180 404.343 180 406V447H178V406C178 405.448 177.552 405 177 405H36Z" fill="#c8d8fa" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M36 405C35.4477 405 35 405.448 35 406V447H33V406C33 404.343 34.3431 403 36 403H177C178.657 403 180 404.343 180 406V447H178V406C178 405.448 177.552 405 177 405H36Z" fill="url(#paint8_linear_748_166)" />
